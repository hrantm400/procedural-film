// STUB
// Placeholder for shot 20 'grant-calms' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'grant-calms',
  draw(ctx, t, info) {
    ...
    L.text(ctx, 'STUB 20', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'grant-calms', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'grant-calms', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
