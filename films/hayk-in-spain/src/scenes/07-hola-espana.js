// STUB
// Placeholder for shot 07 'hola-espana' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'hola-espana',
  draw(ctx, t, info) {
    ...
    L.text(ctx, 'STUB 07', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'hola-espana', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'hola-espana', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
