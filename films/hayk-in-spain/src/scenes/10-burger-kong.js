// STUB
// Placeholder for shot 10 'burger-kong' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'burger-kong',
  draw(ctx, t, info) {
    ...
    L.text(ctx, info.shot.title || 'burger-kong', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'burger-kong', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
