// STUB
// Placeholder for shot 26 'the-end' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'the-end',
  draw(ctx, t, info) {
    ...
    L.text(ctx, 'STUB 26', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'the-end', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'the-end', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
