// STUB
// Placeholder for shot 18 'goofy-senses' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'goofy-senses',
  draw(ctx, t, info) {
    ...
    const seed = L.hash('goofy-senses');
    L.paper(ctx);
    ...
    L.text(ctx, 'STUB 18', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'goofy-senses', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'goofy-senses', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
