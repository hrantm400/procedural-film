// STUB
// Placeholder for shot 19 'goofy-rampage' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'goofy-rampage',
  draw(ctx, t, info) {
    ...
    const seed = L.hash('goofy-rampage');
    L.paper(ctx);
    ...
    L.text(ctx, 'STUB 19', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'goofy-rampage', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'goofy-rampage', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
