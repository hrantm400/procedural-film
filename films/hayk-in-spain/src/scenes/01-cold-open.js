// STUB
// Placeholder for shot 01 'cold-open' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'cold-open',
  draw(ctx, t, info) {
    ...
    L.text(ctx, 'STUB 01', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'cold-open', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'cold-open', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
