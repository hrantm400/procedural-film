// STUB
// Placeholder for shot 24 'fly-home' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'fly-home',
  draw(ctx, t, info) {
    ...
    L.text(ctx, 'STUB 24', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'fly-home', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'fly-home', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
