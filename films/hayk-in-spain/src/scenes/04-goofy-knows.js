// STUB
// Placeholder for shot 04 'goofy-knows' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'goofy-knows',
  draw(ctx, t, info) {
    ...
    L.text(ctx, 'STUB 04', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'goofy-knows', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'goofy-knows', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
