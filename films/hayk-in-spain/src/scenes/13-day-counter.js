// STUB
// Placeholder for shot 13 'day-counter' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'day-counter',
  draw(ctx, t, info) {
    ...
    L.text(ctx, 'STUB 13', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'day-counter', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'day-counter', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
