// STUB
// Placeholder for shot 22 'video-call' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'video-call',
  draw(ctx, t, info) {
    ...
    L.text(ctx, 'STUB 22', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'video-call', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'video-call', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
