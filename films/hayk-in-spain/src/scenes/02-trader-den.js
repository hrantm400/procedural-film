// STUB
// Placeholder for shot 02 'trader-den' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'trader-den',
  draw(ctx, t, info) {
    ...
    L.text(ctx, 'STUB 02', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'trader-den', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'trader-den', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
