// STUB
// Placeholder for shot 23 'burger-drop' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'burger-drop',
  draw(ctx, t, info) {
    ...
    L.text(ctx, 'STUB 23', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'burger-drop', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'burger-drop', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
