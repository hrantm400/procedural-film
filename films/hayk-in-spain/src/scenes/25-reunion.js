// STUB
// Placeholder for shot 25 'reunion' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'reunion',
  draw(ctx, t, info) {
    ...
    L.text(ctx, 'STUB 25', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'reunion', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'reunion', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
