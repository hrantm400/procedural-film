// STUB
// Placeholder for shot 09 'kfg' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'kfg',
  draw(ctx, t, info) {
    ...
    L.text(ctx, 'STUB 09', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'kfg', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'kfg', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
