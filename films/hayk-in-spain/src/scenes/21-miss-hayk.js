// STUB
// Placeholder for shot 21 'miss-hayk' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'miss-hayk',
  draw(ctx, t, info) {
    ...
    L.text(ctx, 'STUB 21', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'miss-hayk', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'miss-hayk', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
