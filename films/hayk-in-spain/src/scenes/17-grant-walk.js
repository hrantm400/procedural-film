// STUB
// Placeholder for shot 17 'grant-walk' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'grant-walk',
  draw(ctx, t, info) {
    ...
    L.text(ctx, 'STUB 17', cx, H * 0.17, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'grant-walk', cx, safeBottom - 120, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'grant-walk', cx, safeBottom - 70, { size: 30, align: 'center', color: P.inkSoft });
